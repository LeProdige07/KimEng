        ...
        <nav class="navbar navbar-expand-lg navbar-light px-0">
            ...
            <div class="logo">
                <a class="d-block" href="{{ url('/') }}">
                    <img loading="lazy" class="logo-default" style="height : 100px; width : 100px" src="{{asset('frontend/images/logos/LOGO-KIM-SARL-BLACK.png')}}" alt="logo" />
                    <img loading="lazy" class="logo-white" style="height : 100px; width : 100px" src="{{asset('frontend/images/logos/LOGO-KIM-SARL-WHITE.png')}}" alt="logo" />
                </a>
            </div>
            <!-- /logo -->

...
@endsection
@section('breadcrumb')
<li class="breadcrumb-item"><a href="{{route('logettes.index')}}">KIM BOX</a></li>
<li class="breadcrumb-item active">Ajout d'une information</li>
@endsection
@section('content')
  <!-- Main content -->
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Ajouter une information</h3>
              </div>
              @if (count($errors) > 0)

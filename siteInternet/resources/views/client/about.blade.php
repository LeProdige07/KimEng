	...
	<div class="container">
		<div class="row">
			<div class="col-lg-6 mt-20">
				...
				<p>Nous vous écoutons, comprenons vos besoins, les étudions pour vous apporter une solution numérique adaptée.</p>
				<p>Nous concevons des solutions numériques adaptées à vos besoins, à un prix accessible à tout le monde.</p>
				<p>Une équipe qui travaille avec dévouement et passion, qui réalise chaque projet avec beaucoup de professionalisme.
	...
	<div class="container">
		<div class="row">
			<div class="col-md-6">
				...
				<p>Et parce que chaque jour, nous sommes confrontés aux problèmes, nous continuerons à innover pour vous apporter les solutions 
			...
			<div class="col-md-6 mt-5 mt-md-0">
				...
				<p>Nous sommes à l'ère du numérique, la 4ème révolution industrielle. La seule option qui se présente à notre pays est de s'adapter ou de disparaitre.
					C'est pourquoi nous nous donnons cette lourde charge de révolutionner la RDC avec les nouvelles technologies.</p> 

...
<head>
    ...
    <link rel="icon" type="image/png" href="{{asset('frontend/images/logos/LOGO-KIM-BLACK-PNG.png', env('REDIRECT_HTTPS'))}}">
    ...
    <link rel="stylesheet"
        href="{{ asset('backend/plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css', env('REDIRECT_HTTPS')) }}">
    <!-- iCheck -->
...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <!-- Navbar -->
        @include('include_pages.admin_navbar')
        <!-- /.navbar -->

        <!-- Main Sidebar Container -->
        {{-- start left side bar --}}

        @include('include_pages.admin_leftsidebar')
        {{-- end left side bar --}}
        ...
        {{-- end content --}}
        {{-- start footer --}}
        @include('include_pages.admin_footer')
        {{-- end footer --}}
